...
def crop_long(image, img_no):
  ...
  cv2.imshow('longitude',img_concate_Hori)


def crop_lat(image, img_no):
  cropped_image_lat1 = image.crop((405, 1132, 430, 1166))
  cropped_image_lat2 = image.crop((432, 1132, 457, 1166))
  cropped_image_lat3 = image.crop((470, 1132, 495, 1166))
  cropped_image_lat4 = image.crop((498, 1132, 523, 1166))
  cropped_image_lat5 = image.crop((525, 1132, 550, 1166))
  cropped_image_lat6 = image.crop((551, 1132, 576, 1166))
  cropped_image_lat7 = image.crop((578, 1132, 603, 1166))
  cropped_image_lat8 = image.crop((604, 1132, 629, 1166))
  cropped_img_loc_lat1 = "coordinates/all_digits/lat_crop_1_%s"%(img_no)
  cropped_img_loc_lat2 = "coordinates/all_digits/lat_crop_2_%s"%(img_no)
  cropped_img_loc_lat3 = "coordinates/all_digits/lat_crop_3_%s"%(img_no)
  cropped_img_loc_lat4 = "coordinates/all_digits/lat_crop_4_%s"%(img_no)
  cropped_img_loc_lat5 = "coordinates/all_digits/lat_crop_5_%s"%(img_no)
  cropped_img_loc_lat6 = "coordinates/all_digits/lat_crop_6_%s"%(img_no)
  cropped_img_loc_lat7 = "coordinates/all_digits/lat_crop_7_%s"%(img_no)
  cropped_img_loc_lat8 = "coordinates/all_digits/lat_crop_8_%s"%(img_no)
  cropped_image_lat1.save(cropped_img_loc_lat1)
  cropped_image_lat2.save(cropped_img_loc_lat2)
  cropped_image_lat3.save(cropped_img_loc_lat3)
  cropped_image_lat4.save(cropped_img_loc_lat4)
  cropped_image_lat5.save(cropped_img_loc_lat5)
  cropped_image_lat6.save(cropped_img_loc_lat6)
  cropped_image_lat7.save(cropped_img_loc_lat7)
  cropped_image_lat8.save(cropped_img_loc_lat8)
  lat_img_crop1 = cv2.imread(cropped_img_loc_lat1)
  lat_img_crop1  = cv2.copyMakeBorder(lat_img_crop1 , 10, 10, 10, 10, cv2.BORDER_CONSTANT)
  lat_img_crop2 = cv2.imread(cropped_img_loc_lat2)
  lat_img_crop2 = cv2.copyMakeBorder(lat_img_crop2, 10, 10, 10, 10, cv2.BORDER_CONSTANT)
  lat_img_crop3 = cv2.imread(cropped_img_loc_lat3)
  lat_img_crop3 = cv2.copyMakeBorder(lat_img_crop3, 10, 10, 10, 10, cv2.BORDER_CONSTANT)
  lat_img_crop4 = cv2.imread(cropped_img_loc_lat4)
  lat_img_crop4 = cv2.copyMakeBorder(lat_img_crop4, 10, 10, 10, 10, cv2.BORDER_CONSTANT)
  lat_img_crop5 = cv2.imread(cropped_img_loc_lat5)
  lat_img_crop5 = cv2.copyMakeBorder(lat_img_crop5, 10, 10, 10, 10, cv2.BORDER_CONSTANT)
  lat_img_crop6 = cv2.imread(cropped_img_loc_lat6)
  lat_img_crop6 = cv2.copyMakeBorder(lat_img_crop6, 10, 10, 10, 10, cv2.BORDER_CONSTANT)
  lat_img_crop7 = cv2.imread(cropped_img_loc_lat7)
  lat_img_crop7 = cv2.copyMakeBorder(lat_img_crop7, 10, 10, 10, 10, cv2.BORDER_CONSTANT)
  lat_img_crop8 = cv2.imread(cropped_img_loc_lat8)
  lat_img_crop8 = cv2.copyMakeBorder(lat_img_crop8, 10, 10, 10, 10, cv2.BORDER_CONSTANT)
  img_concate_Hori = np.concatenate((lat_img_crop1,lat_img_crop2,lat_img_crop3,lat_img_crop4,lat_img_crop5,lat_img_crop6,lat_img_crop7,lat_img_crop8), axis=1)
  cv2.imshow('latitude',img_concate_Hori)
